...
import com.market.*;
import com.sale.*;
import com.view.ShoppingCartView;
...
public class App {
    public static void main(String[] args) {
        ...
        GroceryMarket marketList = new GroceryMarketImpl();
        view.setModelProduct(marketList.getListCodeProduct(groceryMarket));

        view.setTerminal(groceryMarket);
        view.start("Grocery Market","Buy");
